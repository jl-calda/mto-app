...
// Rewired from the original static port to the real engine (Brief 06/07/08):
// height primitive → auto-split flights, spacing (rungs/brackets), threshold (cage
// hoops), pack_stock (stiles), and derived rest-platforms all computed live.
// The walkway attachment section returns with Brief 09.
